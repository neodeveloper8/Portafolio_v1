...
const socialLinks = [
  {
    ...
    subText: "Gonzalo Sierra Tapia",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/gonzalo-alonso-sierra-tapia-62571a21b",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@gonzalos8",
    icon: Instagram,
    url: "https://www.instagram.com/gonzalos8/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@neodeveloper8",
    icon: Github,
    url: "https://github.com/neodeveloper8",
    color: "#ffffff",
...
const SocialLinks = () => {
  // Filtramos para obtener tus redes actuales
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Segunda Fila - Instagram y GitHub lado a lado */}
